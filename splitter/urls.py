...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/itinerary$', views.itinerary, name = 'trip_itinerary'),
    url(r'^(?P<pk>[0-9]+)/itinerary/(?P<hash_val>[-0-9]+)$', views.published_itinerary, name='public_itinerary_url'),
